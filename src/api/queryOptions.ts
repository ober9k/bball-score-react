import { homeQueryFn, playerQueryFn, playersQueryFn, playerTeamQueryFn, standingsQueryFn, statisticsQueryFn, teamPlayersQueryFn, teamQueryFn, teamsQueryFn } from "./queryFunctions.ts";
