...
import UpdateForm, { buildInitialState } from "@/pages/manager/seasons/forms/update-form.tsx";
...
export function UpdatePage() {
  ...
  const [ formState, formAction, isPending ] = useActionState(buildFormAction(mutation), buildInitialState(season));
